...
const Home = () => {
  ...
  return (
    <div className="w-screen">
      ...
      <>
        <section className="h-[627px] overflow-hidden relative bg-[url('/images/portrait-nurse.jpg')]bg-no-repeat bg-center bg-auto md:bg-cover opacity-90 w-[100vw]  "></section>
        ...
        <div className="sm:w-[94%] text-xs sm:text-[14px] w-[600px] mx-2  sm:mx-auto my-8 sm:px-10">
          ...
          >
            <div className="embla__viewport" ref={viewportRef}>
              ...
              <div className="embla__slide">
                <Image alt="netflix" src="/images/netflix.jpg" className="w-[120px] h-[100px]" />
              </div>
              <div className="embla__slide">
